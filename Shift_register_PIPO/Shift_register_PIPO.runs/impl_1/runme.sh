...
HD_PWD='D:/Vivado/Master_slave/Shift_register_PIPO/Shift_register_PIPO.runs/impl_1'
cd "$HD_PWD"
...
EAStep vivado -log shift_register_PIPO.vdi -applog -m64 -product Vivado -messageDb vivado.pb -mode batch -source shift_register_PIPO.tcl -notrace

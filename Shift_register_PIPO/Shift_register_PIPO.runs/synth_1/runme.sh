...
HD_PWD='D:/Vivado/Master_slave/Shift_register_PIPO/Shift_register_PIPO.runs/synth_1'
cd "$HD_PWD"
...
EAStep vivado -log shift_register_PIPO.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source shift_register_PIPO.tcl

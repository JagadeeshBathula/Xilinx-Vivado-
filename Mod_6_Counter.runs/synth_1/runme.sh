...
HD_PWD='D:/Vivado/Mod_6_Counter/Mod_6_Counter.runs/synth_1'
cd "$HD_PWD"
...
EAStep vivado -log mod_6_counter.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source mod_6_counter.tcl

...
HD_PWD='D:/Vivado/T_latch/T_latch.runs/impl_1'
cd "$HD_PWD"
...
EAStep vivado -log T_latch.vdi -applog -m64 -product Vivado -messageDb vivado.pb -mode batch -source T_latch.tcl -notrace

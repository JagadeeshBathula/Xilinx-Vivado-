...
HD_PWD='D:/Vivado/T_latch/T_latch.runs/synth_1'
cd "$HD_PWD"
...
EAStep vivado -log T_latch.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source T_latch.tcl

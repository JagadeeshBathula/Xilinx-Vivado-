...
HD_PWD='D:/Vivado/4bit_adder/4bit_adder.runs/synth_1'
cd "$HD_PWD"
...
EAStep vivado -log rp_adder.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source rp_adder.tcl

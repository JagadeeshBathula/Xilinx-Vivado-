...
HD_PWD='D:/Vivado/4bit_adder/4bit_adder.runs/impl_1'
cd "$HD_PWD"
...
EAStep vivado -log rp_adder.vdi -applog -m64 -product Vivado -messageDb vivado.pb -mode batch -source rp_adder.tcl -notrace

...
HD_PWD='D:/Vivado/Master_slave/Shift_register_SIPO/Shift_register_SIPO.runs/synth_1'
cd "$HD_PWD"
...
EAStep vivado -log shift_register_SIPO.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source shift_register_SIPO.tcl

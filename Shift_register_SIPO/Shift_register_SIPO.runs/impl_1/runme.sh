...
HD_PWD='D:/Vivado/Master_slave/Shift_register_SIPO/Shift_register_SIPO.runs/impl_1'
cd "$HD_PWD"
...
EAStep vivado -log shift_register_SIPO.vdi -applog -m64 -product Vivado -messageDb vivado.pb -mode batch -source shift_register_SIPO.tcl -notrace

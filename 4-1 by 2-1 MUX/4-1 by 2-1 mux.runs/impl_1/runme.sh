...
HD_PWD='D:/Vivado/4-1 by 2-1 mux/4-1 by 2-1 mux.runs/impl_1'
cd "$HD_PWD"
...
EAStep vivado -log mux4_1by2_1.vdi -applog -m64 -product Vivado -messageDb vivado.pb -mode batch -source mux4_1by2_1.tcl -notrace

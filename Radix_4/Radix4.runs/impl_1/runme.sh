...
HD_PWD='D:/Vivado/Radix4/Radix4.runs/impl_1'
cd "$HD_PWD"
...
EAStep vivado -log RADIX4_BOOTHMULTIPLIER32BIT.vdi -applog -m64 -product Vivado -messageDb vivado.pb -mode batch -source RADIX4_BOOTHMULTIPLIER32BIT.tcl -notrace

...
HD_PWD='D:/Vivado/Radix4/Radix4.runs/synth_1'
cd "$HD_PWD"
...
EAStep vivado -log RADIX4_BOOTHMULTIPLIER32BIT.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source RADIX4_BOOTHMULTIPLIER32BIT.tcl

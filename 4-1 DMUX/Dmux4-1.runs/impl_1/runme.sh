...
HD_PWD='D:/Vivado/Dmux4-1/Dmux4-1.runs/impl_1'
cd "$HD_PWD"
...
EAStep vivado -log dmux4_1.vdi -applog -m64 -product Vivado -messageDb vivado.pb -mode batch -source dmux4_1.tcl -notrace

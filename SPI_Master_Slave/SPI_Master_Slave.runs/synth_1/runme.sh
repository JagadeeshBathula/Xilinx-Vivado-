...
HD_PWD='D:/Vivado/Master_slave/SPI_Master_Slave/SPI_Master_Slave.runs/synth_1'
cd "$HD_PWD"
...
EAStep vivado -log Slave_SPI.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source Slave_SPI.tcl

...
HD_PWD='D:/Vivado/Master_slave/SPI_Master_Slave/SPI_Master_Slave.runs/impl_1'
cd "$HD_PWD"
...
EAStep vivado -log Slave_SPI.vdi -applog -m64 -product Vivado -messageDb vivado.pb -mode batch -source Slave_SPI.tcl -notrace

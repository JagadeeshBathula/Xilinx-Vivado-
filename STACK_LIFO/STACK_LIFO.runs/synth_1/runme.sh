...
HD_PWD='D:/Vivado/STACK_LIFO/STACK_LIFO.runs/synth_1'
cd "$HD_PWD"
...
EAStep vivado -log stack_lifo.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source stack_lifo.tcl

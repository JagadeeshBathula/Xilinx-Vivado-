...
HD_PWD='D:/Vivado/STACK_LIFO/STACK_LIFO.runs/impl_1'
cd "$HD_PWD"
...
EAStep vivado -log stack_lifo.vdi -applog -m64 -product Vivado -messageDb vivado.pb -mode batch -source stack_lifo.tcl -notrace

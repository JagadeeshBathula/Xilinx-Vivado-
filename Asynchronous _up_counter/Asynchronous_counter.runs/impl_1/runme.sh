...
HD_PWD='D:/Vivado/Asynchronous_counter/Asynchronous_counter.runs/impl_1'
cd "$HD_PWD"
...
EAStep vivado -log async_counter.vdi -applog -m64 -product Vivado -messageDb vivado.pb -mode batch -source async_counter.tcl -notrace

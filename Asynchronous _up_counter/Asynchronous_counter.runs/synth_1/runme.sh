...
HD_PWD='D:/Vivado/Asynchronous_counter/Asynchronous_counter.runs/synth_1'
cd "$HD_PWD"
...
EAStep vivado -log async_counter.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source async_counter.tcl

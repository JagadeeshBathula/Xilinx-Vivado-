...
HD_PWD='D:/Vivado/water_tank_control/water_tank_control.runs/impl_1'
cd "$HD_PWD"
...
EAStep vivado -log water_tank_control.vdi -applog -m64 -product Vivado -messageDb vivado.pb -mode batch -source water_tank_control.tcl -notrace

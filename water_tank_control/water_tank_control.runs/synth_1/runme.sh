...
HD_PWD='D:/Vivado/water_tank_control/water_tank_control.runs/synth_1'
cd "$HD_PWD"
...
EAStep vivado -log water_tank_control.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source water_tank_control.tcl

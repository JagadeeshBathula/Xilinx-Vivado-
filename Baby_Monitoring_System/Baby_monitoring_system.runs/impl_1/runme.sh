...
HD_PWD='D:/Vivado/Baby_monitoring_system/Baby_monitoring_system.runs/impl_1'
cd "$HD_PWD"
...
EAStep vivado -log baby_monitor_top.vdi -applog -m64 -product Vivado -messageDb vivado.pb -mode batch -source baby_monitor_top.tcl -notrace

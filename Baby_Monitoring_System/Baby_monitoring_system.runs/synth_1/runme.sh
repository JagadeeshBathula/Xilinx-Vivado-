...
HD_PWD='D:/Vivado/Baby_monitoring_system/Baby_monitoring_system.runs/synth_1'
cd "$HD_PWD"
...
EAStep vivado -log baby_monitor_top.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source baby_monitor_top.tcl

...
HD_PWD='D:/Vivado/Master_slave/Frequency_Divider/Frequency_Divider.runs/synth_1'
cd "$HD_PWD"
...
EAStep vivado -log Freq_divider_by_4.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source Freq_divider_by_4.tcl

...
HD_PWD='D:/Vivado/Master_slave/Frequency_Divider/Frequency_Divider.runs/impl_1'
cd "$HD_PWD"
...
EAStep vivado -log Freq_divider_by_4.vdi -applog -m64 -product Vivado -messageDb vivado.pb -mode batch -source Freq_divider_by_4.tcl -notrace

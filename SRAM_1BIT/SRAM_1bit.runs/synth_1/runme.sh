...
HD_PWD='D:/Vivado/SRAM_1bit/SRAM_1bit.runs/synth_1'
cd "$HD_PWD"
...
EAStep vivado -log SRAM_1bit.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source SRAM_1bit.tcl

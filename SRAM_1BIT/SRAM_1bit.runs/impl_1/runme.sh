...
HD_PWD='D:/Vivado/SRAM_1bit/SRAM_1bit.runs/impl_1'
cd "$HD_PWD"
...
EAStep vivado -log SRAM_1bit.vdi -applog -m64 -product Vivado -messageDb vivado.pb -mode batch -source SRAM_1bit.tcl -notrace

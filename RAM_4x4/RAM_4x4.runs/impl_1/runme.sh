...
HD_PWD='D:/Vivado/RAM_4x4/RAM_4x4.runs/impl_1'
cd "$HD_PWD"
...
EAStep vivado -log ram_4x4.vdi -applog -m64 -product Vivado -messageDb vivado.pb -mode batch -source ram_4x4.tcl -notrace

...
HD_PWD='D:/Vivado/RAM_4x4/RAM_4x4.runs/synth_1'
cd "$HD_PWD"
...
EAStep vivado -log ram_4x4.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source ram_4x4.tcl

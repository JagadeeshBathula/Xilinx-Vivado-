...
HD_PWD='D:/Vivado/Mod_10_Counter/Mod_10_Counter.runs/synth_1'
cd "$HD_PWD"
...
EAStep vivado -log mod_10_counter.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source mod_10_counter.tcl

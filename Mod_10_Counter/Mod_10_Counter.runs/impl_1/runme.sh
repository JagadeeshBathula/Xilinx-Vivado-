...
HD_PWD='D:/Vivado/Mod_10_Counter/Mod_10_Counter.runs/impl_1'
cd "$HD_PWD"
...
EAStep vivado -log mod_10_counter.vdi -applog -m64 -product Vivado -messageDb vivado.pb -mode batch -source mod_10_counter.tcl -notrace

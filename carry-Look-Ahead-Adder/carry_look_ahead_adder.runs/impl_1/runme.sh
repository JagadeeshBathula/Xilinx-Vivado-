...
HD_PWD='D:/Vivado/carry_look_ahead_adder/carry_look_ahead_adder.runs/impl_1'
cd "$HD_PWD"
...
EAStep vivado -log CLA_4bit.vdi -applog -m64 -product Vivado -messageDb vivado.pb -mode batch -source CLA_4bit.tcl -notrace

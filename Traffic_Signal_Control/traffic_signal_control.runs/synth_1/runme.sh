...
HD_PWD='D:/Vivado/traffic_signal_control/traffic_signal_control.runs/synth_1'
cd "$HD_PWD"
...
EAStep vivado -log traffic_signal_control.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source traffic_signal_control.tcl

...
HD_PWD='D:/Vivado/traffic_signal_control/traffic_signal_control.runs/impl_1'
cd "$HD_PWD"
...
EAStep vivado -log traffic_signal_control.vdi -applog -m64 -product Vivado -messageDb vivado.pb -mode batch -source traffic_signal_control.tcl -notrace

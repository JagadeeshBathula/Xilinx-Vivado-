...
HD_PWD='D:/Vivado/mux8_1/mux8_1.runs/impl_1'
cd "$HD_PWD"
...
EAStep vivado -log mux8_1.vdi -applog -m64 -product Vivado -messageDb vivado.pb -mode batch -source mux8_1.tcl -notrace

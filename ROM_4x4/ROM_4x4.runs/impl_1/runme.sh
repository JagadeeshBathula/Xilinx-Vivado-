...
HD_PWD='D:/Vivado/ROM_4x4/ROM_4x4.runs/impl_1'
cd "$HD_PWD"
...
EAStep vivado -log rom_4x4.vdi -applog -m64 -product Vivado -messageDb vivado.pb -mode batch -source rom_4x4.tcl -notrace

...
HD_PWD='D:/Vivado/ROM_4x4/ROM_4x4.runs/synth_1'
cd "$HD_PWD"
...
EAStep vivado -log rom_4x4.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source rom_4x4.tcl

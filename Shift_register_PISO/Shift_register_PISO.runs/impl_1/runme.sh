...
HD_PWD='D:/Vivado/Master_slave/Shift_register_PISO/Shift_register_PISO.runs/impl_1'
cd "$HD_PWD"
...
EAStep vivado -log shift_register_PISO.vdi -applog -m64 -product Vivado -messageDb vivado.pb -mode batch -source shift_register_PISO.tcl -notrace

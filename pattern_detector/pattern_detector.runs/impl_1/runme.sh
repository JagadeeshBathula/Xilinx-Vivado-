...
HD_PWD='D:/Vivado/pattern_detector/pattern_detector.runs/impl_1'
cd "$HD_PWD"
...
EAStep vivado -log pattern_detector.vdi -applog -m64 -product Vivado -messageDb vivado.pb -mode batch -source pattern_detector.tcl -notrace

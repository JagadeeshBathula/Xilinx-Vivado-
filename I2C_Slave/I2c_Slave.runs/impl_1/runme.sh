...
HD_PWD='D:/Vivado/I2c_Slave/I2c_Slave.runs/impl_1'
cd "$HD_PWD"
...
EAStep vivado -log i2c_slave.vdi -applog -m64 -product Vivado -messageDb vivado.pb -mode batch -source i2c_slave.tcl -notrace

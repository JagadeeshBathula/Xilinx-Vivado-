...
HD_PWD='D:/Vivado/JK_flip_flop/JK_flip_flop.runs/impl_1'
cd "$HD_PWD"
...
EAStep vivado -log JK_flip_flop.vdi -applog -m64 -product Vivado -messageDb vivado.pb -mode batch -source JK_flip_flop.tcl -notrace

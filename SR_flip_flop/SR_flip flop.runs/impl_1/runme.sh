...
HD_PWD='D:/Vivado/SR_flip flop/SR_flip flop.runs/impl_1'
cd "$HD_PWD"
...
EAStep vivado -log SR_flip_flop.vdi -applog -m64 -product Vivado -messageDb vivado.pb -mode batch -source SR_flip_flop.tcl -notrace

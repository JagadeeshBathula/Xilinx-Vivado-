...
HD_PWD='D:/Vivado/T_flip_flop/T_flip_flop.runs/impl_1'
cd "$HD_PWD"
...
EAStep vivado -log T_flip_flop.vdi -applog -m64 -product Vivado -messageDb vivado.pb -mode batch -source T_flip_flop.tcl -notrace

...
namespace eval ::optrace {
  variable script "D:/Vivado/T_flip_flop/T_flip_flop.runs/synth_1/T_flip_flop.tcl"
...
read_verilog -library xil_defaultlib D:/Vivado/T_flip_flop/T_flip_flop.srcs/sources_1/new/T_flip_flop.v
...
synth_design -top T_flip_flop -part xc7a25ticsg325-1L
...
write_checkpoint -force -noxdef T_flip_flop.dcp
OPTRACE "write_checkpoint" END { }
OPTRACE "synth reports" START { REPORT }
generate_parallel_reports -reports { "report_utilization -file T_flip_flop_utilization_synth.rpt -pb T_flip_flop_utilization_synth.pb"  } 

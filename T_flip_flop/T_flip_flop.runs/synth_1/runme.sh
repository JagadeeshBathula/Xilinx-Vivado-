...
HD_PWD='D:/Vivado/T_flip_flop/T_flip_flop.runs/synth_1'
cd "$HD_PWD"
...
EAStep vivado -log T_flip_flop.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source T_flip_flop.tcl

...
HD_PWD='D:/Vivado/G to B converterr/G to B converterr.runs/synth_1'
cd "$HD_PWD"
...
EAStep vivado -log GtoB.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source GtoB.tcl

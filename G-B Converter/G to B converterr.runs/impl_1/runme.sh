...
HD_PWD='D:/Vivado/G to B converterr/G to B converterr.runs/impl_1'
cd "$HD_PWD"
...
EAStep vivado -log GtoB.vdi -applog -m64 -product Vivado -messageDb vivado.pb -mode batch -source GtoB.tcl -notrace

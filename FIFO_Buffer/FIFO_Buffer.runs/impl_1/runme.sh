...
HD_PWD='D:/Vivado/FIFO_Buffer/FIFO_Buffer.runs/impl_1'
cd "$HD_PWD"
...
EAStep vivado -log fifo_buffer.vdi -applog -m64 -product Vivado -messageDb vivado.pb -mode batch -source fifo_buffer.tcl -notrace

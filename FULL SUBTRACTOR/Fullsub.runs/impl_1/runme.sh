...
HD_PWD='D:/Vivado/Fullsub/Fullsub.runs/impl_1'
cd "$HD_PWD"
...
EAStep vivado -log fsub.vdi -applog -m64 -product Vivado -messageDb vivado.pb -mode batch -source fsub.tcl -notrace

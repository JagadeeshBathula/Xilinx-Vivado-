...
HD_PWD='D:/Vivado/Digital_Door_Lock/Digital_Door_Lock.runs/synth_1'
cd "$HD_PWD"
...
EAStep vivado -log digital_door_lock.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source digital_door_lock.tcl

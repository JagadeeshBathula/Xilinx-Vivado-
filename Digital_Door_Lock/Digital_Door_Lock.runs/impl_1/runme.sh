...
HD_PWD='D:/Vivado/Digital_Door_Lock/Digital_Door_Lock.runs/impl_1'
cd "$HD_PWD"
...
EAStep vivado -log digital_door_lock.vdi -applog -m64 -product Vivado -messageDb vivado.pb -mode batch -source digital_door_lock.tcl -notrace

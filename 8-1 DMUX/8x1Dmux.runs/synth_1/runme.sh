...
HD_PWD='D:/Vivado/8x1Dmux/8x1Dmux.runs/synth_1'
cd "$HD_PWD"
...
EAStep vivado -log dmux8_1.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source dmux8_1.tcl

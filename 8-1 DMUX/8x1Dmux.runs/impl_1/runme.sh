...
HD_PWD='D:/Vivado/8x1Dmux/8x1Dmux.runs/impl_1'
cd "$HD_PWD"
...
EAStep vivado -log dmux8_1.vdi -applog -m64 -product Vivado -messageDb vivado.pb -mode batch -source dmux8_1.tcl -notrace

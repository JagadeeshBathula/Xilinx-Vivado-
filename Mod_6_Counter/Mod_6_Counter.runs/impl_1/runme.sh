...
HD_PWD='D:/Vivado/Mod_6_Counter/Mod_6_Counter.runs/impl_1'
cd "$HD_PWD"
...
EAStep vivado -log mod_6_counter.vdi -applog -m64 -product Vivado -messageDb vivado.pb -mode batch -source mod_6_counter.tcl -notrace

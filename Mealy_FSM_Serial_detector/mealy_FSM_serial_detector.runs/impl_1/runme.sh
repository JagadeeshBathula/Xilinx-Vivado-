...
HD_PWD='D:/Vivado/mealy_FSM_serial_detector/mealy_FSM_serial_detector.runs/impl_1'
cd "$HD_PWD"
...
EAStep vivado -log mealy_fsm_serial_detector.vdi -applog -m64 -product Vivado -messageDb vivado.pb -mode batch -source mealy_fsm_serial_detector.tcl -notrace

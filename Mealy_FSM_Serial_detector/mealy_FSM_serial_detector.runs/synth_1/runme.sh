...
HD_PWD='D:/Vivado/mealy_FSM_serial_detector/mealy_FSM_serial_detector.runs/synth_1'
cd "$HD_PWD"
...
EAStep vivado -log mealy_fsm_serial_detector.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source mealy_fsm_serial_detector.tcl

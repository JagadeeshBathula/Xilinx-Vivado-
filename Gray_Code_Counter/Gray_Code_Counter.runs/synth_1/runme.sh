...
HD_PWD='D:/Vivado/Gray_Code_Counter/Gray_Code_Counter.runs/synth_1'
cd "$HD_PWD"
...
EAStep vivado -log gray_code_counter.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source gray_code_counter.tcl

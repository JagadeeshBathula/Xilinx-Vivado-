...
HD_PWD='D:/Vivado/Gray_Code_Counter/Gray_Code_Counter.runs/impl_1'
cd "$HD_PWD"
...
EAStep vivado -log gray_code_counter.vdi -applog -m64 -product Vivado -messageDb vivado.pb -mode batch -source gray_code_counter.tcl -notrace

...
HD_PWD='D:/Vivado/Moore_FSM_safe_lock/Moore_FSM_safe_lock.runs/synth_1'
cd "$HD_PWD"
...
EAStep vivado -log moore_fsm_safe_lock.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source moore_fsm_safe_lock.tcl

...
HD_PWD='D:/Vivado/Moore_FSM_safe_lock/Moore_FSM_safe_lock.runs/impl_1'
cd "$HD_PWD"
...
EAStep vivado -log moore_fsm_safe_lock.vdi -applog -m64 -product Vivado -messageDb vivado.pb -mode batch -source moore_fsm_safe_lock.tcl -notrace

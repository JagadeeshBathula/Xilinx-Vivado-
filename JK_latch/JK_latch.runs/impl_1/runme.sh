...
HD_PWD='D:/Vivado/JK_latch/JK_latch.runs/impl_1'
cd "$HD_PWD"
...
EAStep vivado -log JK_latch.vdi -applog -m64 -product Vivado -messageDb vivado.pb -mode batch -source JK_latch.tcl -notrace

...
HD_PWD='D:/Vivado/JK_latch/JK_latch.runs/synth_1'
cd "$HD_PWD"
...
EAStep vivado -log JK_latch.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source JK_latch.tcl
